...
//  GitHubFollowers
//
//  Created by Pablo Carmona Esparza on 1/4/23.
//
...
class FollowersCell: UICollectionViewCell {
    ...
    let usernameLabel   = GitHubFollowersBodyLabel(textAlingment: .center, font: .body)
    ...
    private func configure() {
        ...
        NSLayoutConstraint.activate([
            ...
            usernameLabel.topAnchor.constraint(equalTo: self.avatarImageView.bottomAnchor, constant: 12),
